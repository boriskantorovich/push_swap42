...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/19 13:04:49 by bkantoro          #+#    #+#             */
/*   Updated: 2026/06/19 13:04:51 by bkantoro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	dispatch_helper(t_stack *a, t_stack *b, t_ops *ops)
{
	...
	{
		ops->strategy = ALG_ADA_MEDIUM;
		chunk_sort(a, b, ops);
	}
	else
	{
		ops->strategy = ALG_ADA_COMPLEX;
		radix_sort(a, b, ops);
	}
}
